...
Classification and regression trees are easy to understand, but their simplicity means they have high variance. Averaging many such trees together as in bagging leads to a substantial reduction in variance. Random forests increases the complexity further by randomly choosing a fraction of the predictions for each bootstrap split, to decorrelate the trees. Taking this too far, however, by making this number very small or increasing the number of uninformative predictors can end up increasing bias. Hence a middleground of complexity is more optimal. This is how you end up with the "U" shaped MSE curve in most textbook examples. While we did not address gradient-descent based algorithms, such algorithms take advantage of this shape to descent the error gradient and reach the point with lowest error. 
